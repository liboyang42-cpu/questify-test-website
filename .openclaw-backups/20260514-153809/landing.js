...
const videos = {
  ...
  service1: 'https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260314_131748_f2ca2a28-fed7-44c8-b9a9-bd9acdd5ec31.mp4',
  service2: 'https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260324_151826_c7218672-6e92-402c-9e45-f1e0f454bdc4.mp4'
};
...
export function mountLanding(root, scheduler) {
  root.innerHTML = `
    ...
    <section class="cinema-chapter cinema-chapter--signal reveal">
      <div class="chapter-signal-grid">
        <div class="chapter-video chapter-video--signal"><video muted autoplay loop playsinline preload="metadata" src="${videos.service1}"></video><div class="chapter-shade"></div></div>
        <div class="chapter-copy chapter-copy--signal"><p class="chapter-kicker" data-mode-field="chapter1Kicker">Chapter 01 / Choose</p><h2 data-mode-field="chapter1Title">选择你的主题。</h2><p data-mode-field="chapter1Body">从悬疑解谜到城市寻宝，从夜游路线到限时挑战。打开城瘾，先选择你今天想玩的城市主题。</p><span data-mode-field="chapter1Meta">寻宝 / 解谜 / 夜游 / 组队 / 限时活动</span></div>
      </div>
    </section>
    <section class="cinema-chapter cinema-chapter--field reveal">
      <video class="chapter-bg-video" muted autoplay loop playsinline preload="metadata" src="${videos.featured}"></video>
      <div class="chapter-depth chapter-depth--one"></div><div class="chapter-depth chapter-depth--two"></div>
      <div class="chapter-field-copy"><p class="chapter-kicker" data-mode-field="chapter2Kicker">Chapter 02 / Team Up</p><h2 data-mode-field="chapter2Title">单人出发，或者组队开局。</h2><p data-mode-field="chapter2Body">你可以一个人完成挑战，也可以邀请朋友加入。合作、竞速、阵营、排行榜，让一次出门变成一局真正的游戏。</p></div>
    </section>
    <section class="cinema-chapter cinema-chapter--systems reveal">
      <div class="chapter-systems-rail"><p data-mode-field="chapter3RailTop">Play</p><p data-mode-field="chapter3RailBottom">City</p></div>
      <div class="chapter-systems-grid">
        <div class="chapter-systems-copy"><p class="chapter-kicker" data-mode-field="chapter3Kicker">Chapter 03 / Play The City</p><h2 data-mode-field="chapter3Title">在真实城市里互动。</h2><p data-mode-field="chapter3Body">街区、地标、公园、展览、市集、商圈和门店都可能成为游戏节点。寻找线索、拍照验证、答题解锁、完成动作或协作挑战。</p></div>
        <div class="chapter-system-panel chapter-system-panel--large"><video muted autoplay loop playsinline preload="metadata" src="${videos.philosophy}"></video><span data-mode-field="panel1">寻找</span><small data-mode-field="panel1Meta">线索扫描 / 城市路径</small></div>
        <div class="chapter-system-panel chapter-system-panel--tall"><video muted autoplay loop playsinline preload="metadata" src="${videos.service2}"></video><span data-mode-field="panel2">解锁</span><small data-mode-field="panel2Meta">拍照验证 / 答题解锁</small></div>
        <div class="chapter-system-panel chapter-system-panel--wide"><video muted autoplay loop playsinline preload="metadata" src="${videos.service1}"></video><span data-mode-field="panel3">挑战</span><small data-mode-field="panel3Meta">协作挑战 / 冲榜奖励</small></div>
      </div>
    </section>
    <section class="cinema-chapter cinema-chapter--finale reveal">
      <video class="chapter-finale-video" muted autoplay loop playsinline preload="metadata" src="${videos.service2}"></video>
      <div class="chapter-finale-copy"><p class="chapter-kicker" data-mode-field="chapter4Kicker">Chapter 04 / Reward</p><h2 data-mode-field="chapter4Title">完成挑战，赢取奖励。</h2><p data-mode-field="chapter4Body">获得城市勋章、等级经验、排行榜积分，也可能赢取红包、现金奖励、隐藏权益和下一场任务的入口。</p><div class="finale-chips" data-mode-list="finaleItems"><span>城市勋章</span><span>排行榜积分</span><span>现金奖励</span><span>隐藏权益</span></div><div class="liquid-glass finale-loop" data-mode-field="finaleLoop">选择主题 → 组队开局 → 城市互动 → 奖励结算</div></div>
    </section>
